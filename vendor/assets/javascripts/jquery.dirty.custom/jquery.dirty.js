...
(function($) {
    ...
    Dirty.prototype = {
        ...
        resetForm: function(){
            ...
            this.form.find("input[type=radio]").each(function(_, e) {
            ...
            this.form.find("input[type=checkbox]").each(function(_, e) {
              var initialCheckedState = $(e).data(dataInitialValue);
              var isChecked = initialCheckedState === "checked";

              $(e).prop("checked", isChecked);

              // Added by Nativapps to compatibility with switchery
              if ($(e).hasClass("js-switch")) {
                $(e).next("span").remove();
              }
            });
